...
public class Game extends Thread{
    ...
    private void sendBotCode(Player player){
        ...
        data.add("botId", player.getBotId().toString());
    ...
    private void sendAllMessage(String message){
        if(WebSocketServer.users.get(Pair.of(playerA.getId(), playerA.getBotId())) != null){
            WebSocketServer.users.get(Pair.of(playerA.getId(), playerA.getBotId())).sendMessage(message);
        }
        if(WebSocketServer.users.get(Pair.of(playerB.getId(), playerB.getBotId())) != null){
            WebSocketServer.users.get(Pair.of(playerB.getId(), playerB.getBotId())).sendMessage(message);
        }
    }
